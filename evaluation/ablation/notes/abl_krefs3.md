...
- k_refs = 3 at sampling time
- sampling protocol: `fewshot_adv`
- `k_refs` overridden to 3
...
Read back from the cache rather than assumed: a drawn sample carries `ref_count = 3` with 3 reference indices, protocol `fewshot_adv`.
