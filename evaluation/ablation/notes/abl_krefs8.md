...
- k_refs = 8 at sampling time
- sampling protocol: `fewshot_adv`
- `k_refs` overridden to 8
...
Read back from the cache rather than assumed: a drawn sample carries `ref_count = 8` with 8 reference indices, protocol `fewshot_adv`.
